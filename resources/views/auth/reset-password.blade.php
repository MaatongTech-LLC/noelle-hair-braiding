            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-title">
                        <h3 class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Reset Password</h3>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="auth-content wow fadeInUp" data-wow-delay="0.75s" style="visibility: visible; animation-delay: 0.75s; animation-name: fadeInUp;">
                        <form id="loginForm" action="{{ route("reset-password.post") }}" method="POST" data-toggle="validator" novalidate="true">
                            @csrf
