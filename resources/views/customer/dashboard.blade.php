                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        My Bookings
                                        <h2 class="counter" style="visibility: visible;">{{ \App\Models\Appointment::where('user_id', auth()->user()->id)->count() }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        Orders
                                        <h2 class="counter" style="visibility: visible;">{{ \App\Models\Order::where('user_id', auth()->user()->id)->count() }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
