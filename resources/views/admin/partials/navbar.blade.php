<nav class="nav navbar navbar-expand-lg navbar-dark bg-dark iq-navbar">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="p-0 sub-drop dropdown-menu dropdown-menu-end" aria-labelledby="notification-drop">
                        <div class="m-0 shadow-none card">
                            <div class="py-3 card-header d-flex justify-content-between" style="background: #f11895;">
                    ...
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title text-white">{{ auth()->user()->name }}</h6>
